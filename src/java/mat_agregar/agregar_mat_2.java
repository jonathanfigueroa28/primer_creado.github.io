...
@WebServlet(urlPatterns = {"/agregar_mat_2"})

public class agregar_mat_2 extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            agregar.agregar_material(new Material(codMaterial,2,cantidad,nombreMaterial));
            ...
            out.println("<td> <a href=\"agregar_mat2.html\">(+)agregar otro material </a> </td>");
            out.println("</tr> </table>");
            
            out.println("<form action = \"materiales2\"> <pre>");
