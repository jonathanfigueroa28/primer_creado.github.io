...
@WebServlet(urlPatterns = {"/agregar_mat_1"})

public class agregar_mat_1 extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            agregar.agregar_material(new Material(codMaterial,1,cantidad,nombreMaterial));
            ...
            out.println("<td> <a href=\"agregar_mat1.html\">(+)agregar otro material </a> </td>");
            ...
            out.println("<form action = \"materiales1\"> <pre>");
