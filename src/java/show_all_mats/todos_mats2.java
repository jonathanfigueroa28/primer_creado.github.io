...
@WebServlet(urlPatterns = {"/todos_mats2"})

public class todos_mats2 extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<td> <a href=\"agregar_mat2.html\">(+)regresar para agregar material a esta categoria</a> </td>");
