...
@WebServlet(urlPatterns = {"/materiales2"})

public class materiales2 extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<Material> mats = lista.listar_mat_cat(2);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<center><h2>CATEGORIA 2: MOBILIARIO</h2></center>");
            ...
            out.println("<td> <a href=\"agregar_mat2.html\">(+)agregar material </a> </td>");
