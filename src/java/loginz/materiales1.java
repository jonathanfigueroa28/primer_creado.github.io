...
@WebServlet(urlPatterns = {"/materiales1"})

public class materiales1 extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            List<Material> mats = lista.listar_mat_cat(1);
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<center><h2>CATEGORIA 1: PEPELERIA</h2></center>");
            ...
            out.println("<td> <a href=\"agregar_mat1.html\">(+)agregar material </a> </td>");
